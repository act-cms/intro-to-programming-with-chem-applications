Lesson 02: Introduction to Transitioning from Excel to Python for Chemical Lab Data Analysis
=======================
...
1. Import your Excel data with the <code>pd.read_csv()</code> or the <code> pd.read_excel()</code> function
2. Construct numerous types of plots with <code> matplotlib </code>
3. There is a high degree of customizability in <code> matplotlib </code> plots
4. The <code>scipy.stats.linregress()</code> function computes best fit line parameters
5. There are plenty of applications to use Python to model chemical data
